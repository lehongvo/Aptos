...
module TitanPowerNFTv1::titan_power_nft_v1 {
    ...
    const NAME_TOKEN: vector<u8> = b"Titan Powner Coin V1";
    const ASSET_SYMBOL: vector<u8> = b"TITAN V1";
    ...
    public fun get_metadata(): Object<Metadata> {
        let asset_address = object::create_object_address(&@TitanPowerNFTv1, ASSET_SYMBOL);
    ...
    // #[test(creator = @TitanPowerNFTv1, aaron = @0xface)]
